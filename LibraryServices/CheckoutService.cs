...
namespace LibraryServices
{
    public class CheckoutService : ICheckout
    {
        ...
        public bool IsCheckedOut(int assetId)
        {
            ...
            var isCheckedOut = _context.Checkouts.Where(a => a.LibraryAsset.Id == assetId).Any();
            return isCheckedOut;
        }
        ...
        {
            return _context.Checkouts.Include(ab => ab.LibraryAsset)
                .Include(ba => ba.LibraryCard)
                .FirstOrDefault(ad => ad.LibraryAsset.Id == assetId);
